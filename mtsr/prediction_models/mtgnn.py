...
class MTGNN(nn.Module):
    def __init__(self, args):
        ...
        skip_channels = 64
        end_channels = 128
        in_dim = args.num_node
        out_dim = args.num_node
        layers = 3
        propalpha = 0.05
        tanhalpha = 3
        ...
        self.start_conv = nn.Conv2d(in_channels=in_dim,
                                    ...
                                    kernel_size=(1, 1))
        self.gc = graph_constructor(self.num_nodes, subgraph_size, node_dim, device, alpha=tanhalpha,
                                    static_feat=static_feat)

        self.seq_length = args.input_len
        kernel_size = 7
