...
def exp_1():
    ...
    for seed in seeds:
        for dataset_id, dataset in enumerate(datasets):
            ...
            os.makedirs('../results/mtsr/exp1', exist_ok=True)
            for k, v in results.items():
                np.savetxt(f'../results/mtsr/exp1/mtsr_prediction_error_vs_prediction_len_{dataset}_{k}_{seed}.txt',
                           results[k], delimiter=',')
...
def exp_2():
    ...
    for seed in seeds:
        for dataset_id, dataset in enumerate(datasets):
            ...
            os.makedirs('../results/mtsr/exp2/', exist_ok=True)
            for k, v in results.items():
                np.savetxt(f'../results/mtsr/exp2/mtsr_prediction_error_vs_input_len_{dataset}_{k}_{seed}.txt',
                           results[k], delimiter=',')
...
def exp_3():
    ...
    for seed in seeds:
        for dataset_id, dataset in enumerate(datasets):
            ...
            os.makedirs('../results/mtsr/exp3/', exist_ok=True)
            for k, v in results.items():
                np.savetxt(f'../results/mtsr/exp3/exp3_{dataset}_{k}_{seed}.txt', results[k], delimiter=',')
...
def exp_4():
    ...
    for seed in seeds:
        ...
        for dataset_id, dataset in enumerate(datasets):
            ...
            os.makedirs('../results/mtsr/exp4/', exist_ok=True)
            for k, v in results.items():
                np.savetxt(f'../results/mtsr/exp4/exp4_{dataset}_{k}_{seed}.txt', results[k], delimiter=',')
...
def exp_11():
    ...
    for dataset_id, dataset in enumerate(datasets):
        ...
        os.makedirs('../results/mtsr/exp11/', exist_ok=True)
        for k, v in results.items():
            np.savetxt(f'../results/mtsr/exp11/exp11_{dataset}_{k}.txt', results[k], delimiter=',')
...
def exp_12():
    ...
    for dataset_id, dataset in enumerate(datasets):
        ...
        os.makedirs('../results/mtsr/exp12/', exist_ok=True)
        for k, v in results.items():
            np.savetxt(f'../results/mtsr/exp12/exp_12{dataset}_{k}.txt', results[k], delimiter=',')
...
def exp_6():
    ...
    for dataset_id, dataset in enumerate(datasets):
        ...
        os.makedirs('../results/mtsr/', exist_ok=True)
        for k, v in results.items():
            np.savetxt(f'../results/mtsr/exp6.2_{dataset}_{k}.txt', results[k], delimiter=',')
...
def exp_8():
    ...
    for seed in seeds:
        for dataset_id, dataset in enumerate(datasets):
            ...
            os.makedirs('../results/mtsr/exp8', exist_ok=True)
            for k, v in results.items():
                np.savetxt(f'../results/mtsr/exp8/mtsr_cs_{method}_{mon_method}_{dataset}_{k}_{seed}.txt', results[k],
                           delimiter=',')
...
def exp_7():
    ...
    for seed in seeds:
        ...
        for dataset_id, dataset in enumerate(datasets):
            ...
            os.makedirs('../results/mtsr/exp7', exist_ok=True)
            for k, v in results.items():
                np.savetxt(f'../results/mtsr/exp7/mtsr_nocs_{method}_{mon_method}_{dataset}_{k}_{seed}.txt', results[k],
                           delimiter=',')
...
def exp_9():
    ...
    for dataset_id, dataset in enumerate(datasets):
        ...
        os.makedirs('../results/mtsr/exp9/', exist_ok=True)
        for k, v in results.items():
            np.savetxt(f'../results/mtsr/exp9/exp9_{dataset}_{k}.txt', results[k], delimiter=',')
...
def exp_10():
    ...
    for seed in seeds:
        ...
        for dataset_id, dataset in enumerate(datasets):
            ...
            os.makedirs('../results/mtsr/exp10/', exist_ok=True)
            for k, v in results.items():
                np.savetxt(f'../results/mtsr/exp10/mtsr_cs_vae_{dataset}_{k}_{seed}.txt', results[k], delimiter=',')
