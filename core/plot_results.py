...
def plot_exp2():
    ...
    for dataset_id, dataset in enumerate(datasets):
        results_mae = []
        for index, seed in enumerate(seeds):
            path = f'../results/core/exp2/mtsr_prediction_error_vs_input_len_{dataset}_mae_{seed}.txt'
            data = np.loadtxt(path, delimiter=',')
            if index == 0:
                results_mae = data
            else:
    ...
    for dataset_id, dataset in enumerate(datasets):
        ...
        for mon_id, mon_method in enumerate(mon_methods):
            ...
            for i, seed in enumerate(seeds):
                ...
                path = f'../results/core/exp8/mtsr_cs_{method}_{mon_method}_{dataset}_mlu_{seed}.txt'
...
def plot_exp7():
    ...
    for dataset_id, dataset in enumerate(datasets):
        ...
        results_mtsr_nocs = []
        for i, seed in enumerate(seeds):
            path = f'../results/core/exp7/mtsr_nocs_mtsr_nocs_topk_random_{dataset}_mlu_{seed}.txt'
            data = np.loadtxt(path, delimiter=',')
        ...
        for mon_id, mon_method in enumerate(mon_methods):
            ...
            for i, seed in enumerate(seeds):
                ...
                path = f'../results/core/exp8/{method}_{method}_{mon_method}_{dataset}_mae_{seed}.txt'
...
def plot_dynamic():
    ...
    for dataset_id, dataset in enumerate(datasets):
        ...
        for seed in seeds:
            ...
            path_te_p1 = f'../logs/core/te-core-gwn-{dataset}-p2-3-15-6-{seed}-p1-False-1.npz'
            path_te_p2 = f'../logs/core/te-core-gwn-{dataset}-p2-3-15-6-{seed}-p2-False-1.npz'
