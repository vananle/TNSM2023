...
class Logger:
    ...
    def __init__(self, args):
        ...
        parent_logs_path = os.path.join(homedir, 'thesis/logs/solver/')

        log_dir = 'mtsr_cs_{}_{}_{}_{}_{}_{}_{}_{}'.format(args.model, args.dataset, args.seq_len_x,
                                                           args.seq_len_y, args.loss_fn, args.type,
                                                           args.mon_rate, args.fs)
